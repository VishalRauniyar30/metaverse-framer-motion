            ...
            >
                ...
                >
                    ...
                    <div>
                        ...
                        <p className="mt-2 font-normal sm:text-lg text-sm sm:leading-[22.68px] leading-[16.68px] text-white">
                            Founded Metaversus
                        </p>
                    </div>
                    <p className="mt-6 font-normal sm:text-2xl text-lg sm:leading-[45.6px] leading-[39.6px] text-white">
